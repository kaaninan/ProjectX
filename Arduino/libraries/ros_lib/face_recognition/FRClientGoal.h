#ifndef _ROS_face_recognition_FRClientGoal_h
#define _ROS_face_recognition_FRClientGoal_h
...
namespace face_recognition
{
  ...
  class FRClientGoal : public ros::Msg
  {
    public:
      uint8_t order_id;
      const char* order_argument;
    ...
    const char * getType(){ return "face_recognition/FRClientGoal"; };
