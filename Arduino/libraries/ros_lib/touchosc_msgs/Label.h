#ifndef _ROS_touchosc_msgs_Label_h
#define _ROS_touchosc_msgs_Label_h
...
namespace touchosc_msgs
{
  ...
  class Label : public ros::Msg
  {
    ...
    const char * getType(){ return "touchosc_msgs/Label"; };
    const char * getMD5(){ return "b5cfc77fbfd3429b0db9743556374f86"; };
