...
<<<<<<< HEAD
echo_and_run cd "/home/ubuntu/ProjectX/ROS/src/rosserial/rosserial_client"
=======
echo_and_run cd "/home/kaaninan/ProjectX/ROS/src/rosserial/rosserial_client"
>>>>>>> develop
...
<<<<<<< HEAD
    ...
    "/usr/bin/python" \
    "/home/ubuntu/ProjectX/ROS/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/ubuntu/ProjectX/ROS/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
...
=======
    ...
    "/usr/bin/python" \
    "/home/kaaninan/ProjectX/ROS/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/kaaninan/ProjectX/ROS/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
