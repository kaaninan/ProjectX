...
<<<<<<< HEAD
echo_and_run cd "/home/ubuntu/ProjectX/ROS/src/rosserial/rosserial_xbee"
=======
echo_and_run cd "/home/kaaninan/ProjectX/ROS/src/rosserial/rosserial_xbee"
>>>>>>> develop
...
<<<<<<< HEAD
    ...
    "/usr/bin/python" \
    "/home/ubuntu/ProjectX/ROS/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/ubuntu/ProjectX/ROS/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
...
=======
    ...
    "/usr/bin/python" \
    "/home/kaaninan/ProjectX/ROS/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/kaaninan/ProjectX/ROS/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
