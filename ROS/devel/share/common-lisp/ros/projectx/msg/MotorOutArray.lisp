...
;//! \htmlinclude MotorOutArray.msg.html

(cl:defclass <MotorOutArray> (roslisp-msg-protocol:ros-message)
  ((id
    :reader id
    :initarg :id
...
(cl:defclass MotorOutArray (<MotorOutArray>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MotorOutArray>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MotorOutArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name projectx-msg:<MotorOutArray> is deprecated: use projectx-msg:MotorOutArray instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <MotorOutArray>))
...
(cl:defmethod pos-val ((m <MotorOutArray>))
...
(cl:defmethod speed-val ((m <MotorOutArray>))
...
(cl:defmethod torque-val ((m <MotorOutArray>))
...
(cl:defmethod rw-val ((m <MotorOutArray>))
...
(cl:defmethod action-val ((m <MotorOutArray>))
  ...
  (action m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotorOutArray>) ostream)
  "Serializes a message object of type '<MotorOutArray>"
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'rw))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorOutArray>) istream)
  "Deserializes a message object of type '<MotorOutArray>"
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'rw) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'rw)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorOutArray>)))
  "Returns string type for a message object of type '<MotorOutArray>"
  "projectx/MotorOutArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorOutArray)))
  "Returns string type for a message object of type 'MotorOutArray"
  "projectx/MotorOutArray")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotorOutArray>)))
  "Returns md5sum for a message object of type '<MotorOutArray>"
  "b23b46468244cd9fc2bd0e16a8568772")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotorOutArray)))
  "Returns md5sum for a message object of type 'MotorOutArray"
  "b23b46468244cd9fc2bd0e16a8568772")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorOutArray>)))
  "Returns full string definition for message of type '<MotorOutArray>"
  (cl:format cl:nil "int64[] id~%int64[] pos~%int64[] speed~%int64[] torque~%int64[] rw~%int64[] action~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorOutArray)))
  "Returns full string definition for message of type 'MotorOutArray"
  (cl:format cl:nil "int64[] id~%int64[] pos~%int64[] speed~%int64[] torque~%int64[] rw~%int64[] action~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MotorOutArray>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'rw) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'action) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MotorOutArray>))
  "Converts a ROS message object to a list"
  (cl:list 'MotorOutArray
    (cl:cons ':id (id msg))
    (cl:cons ':pos (pos msg))
