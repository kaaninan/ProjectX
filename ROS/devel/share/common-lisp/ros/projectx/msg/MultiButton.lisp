...
(cl:defmethod cl:initialize-instance :after ((m <MultiButton>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiButton)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name projectx-msg:<MultiButton> is deprecated: use projectx-msg:MultiButton instead.")))
