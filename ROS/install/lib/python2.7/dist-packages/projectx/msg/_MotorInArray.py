...
"""autogenerated by genpy from projectx/MotorInArray.msg. Do not edit."""
import sys
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.temp = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
      ...
      self.voltage = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
