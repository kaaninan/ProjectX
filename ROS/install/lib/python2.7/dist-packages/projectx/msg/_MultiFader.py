...
"""autogenerated by genpy from projectx/MultiFader.msg. Do not edit."""
import sys
...
class MultiFader(genpy.Message):
  _md5sum = "809deaed82ef6d600e6957164fb63431"
  _type = "projectx/MultiFader"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# TouchOSC Multifader Control
...
"""
  ...
  _slot_types = ['std_msgs/Header','projectx/CommonProperties','uint16','float32[2]','float32[]','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiFader, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_H.pack(self.dimension))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.dimension,) = _struct_H.unpack(str[start:end])
      start = end
      end += 8
