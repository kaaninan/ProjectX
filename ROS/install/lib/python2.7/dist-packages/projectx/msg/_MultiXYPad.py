...
"""autogenerated by genpy from projectx/MultiXYPad.msg. Do not edit."""
import sys
...
class MultiXYPad(genpy.Message):
  _md5sum = "9c4c914fe2ffb44766fc5338b5a82aba"
  _type = "projectx/MultiXYPad"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# TouchOSC MultiXYPad Control
...
"""
  __slots__ = ['header','common','range','x','y','z']
  _slot_types = ['std_msgs/Header','projectx/CommonProperties','float32[2]','float32[5]','float32[5]','bool[5]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiXYPad, self).__init__(*args, **kwds)
      ...
      if self.y is None:
        self.y = [0.,0.,0.,0.,0.]
      if self.z is None:
        self.z = [False,False,False,False,False]
    else:
      self.header = std_msgs.msg.Header()
      self.common = projectx.msg.CommonProperties()
      self.range = [0.,0.]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_5f.pack(*self.x))
      buff.write(_struct_5f.pack(*self.y))
      buff.write(_struct_5B.pack(*self.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.x = _struct_5f.unpack(str[start:end])
      start = end
      end += 20
      self.y = _struct_5f.unpack(str[start:end])
      start = end
      end += 5
      self.z = _struct_5B.unpack(str[start:end])
      self.z = map(bool, self.z)
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.x = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=5)
      start = end
      end += 20
      self.y = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=5)
      start = end
      end += 5
      self.z = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=5)
      self.z = map(bool, self.z)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
