...
"""autogenerated by genpy from projectx/TouchOSC_Common.msg. Do not edit."""
import sys
...
class TouchOSC_Common(genpy.Message):
  _md5sum = "02b274e5694f91306b366760eaca24ef"
  _type = "projectx/TouchOSC_Common"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# TouchOSC Common Control
# Battery, Time
...
"""
  __slots__ = ['header','common']
  _slot_types = ['std_msgs/Header','projectx/CommonProperties']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TouchOSC_Common, self).__init__(*args, **kwds)
