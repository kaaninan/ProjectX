...
"""autogenerated by genpy from projectx/XYPad.msg. Do not edit."""
import sys
...
class XYPad(genpy.Message):
  _md5sum = "ee31b4143f668690ed4f5b021cf85341"
  _type = "projectx/XYPad"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# TouchOSC XYPad Control
...
"""
  ...
  _slot_types = ['std_msgs/Header','projectx/CommonProperties','float32[2]','float32','float32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(XYPad, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2fB.pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.z,) = _struct_2fB.unpack(str[start:end])
      self.z = bool(self.z)
      return self
