...
(cl:defmethod cl:initialize-instance :after ((m <TouchOSC_Common>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TouchOSC_Common)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name projectx-msg:<TouchOSC_Common> is deprecated: use projectx-msg:TouchOSC_Common instead.")))
