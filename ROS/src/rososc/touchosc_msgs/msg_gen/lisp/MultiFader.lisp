...
(cl:defmethod cl:initialize-instance :after ((m <MultiFader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiFader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name touchosc_msgs-msg:<MultiFader> is deprecated: use touchosc_msgs-msg:MultiFader instead.")))
