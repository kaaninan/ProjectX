...
(cl:defmethod cl:initialize-instance :after ((m <MultiXYPad>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiXYPad)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name touchosc_msgs-msg:<MultiXYPad> is deprecated: use touchosc_msgs-msg:MultiXYPad instead.")))
