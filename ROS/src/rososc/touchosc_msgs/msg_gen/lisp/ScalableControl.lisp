...
(cl:defmethod cl:initialize-instance :after ((m <ScalableControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScalableControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name touchosc_msgs-msg:<ScalableControl> is deprecated: use touchosc_msgs-msg:ScalableControl instead.")))
